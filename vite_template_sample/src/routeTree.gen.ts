...
import { Route as MyReportsImport } from './routes/my-reports'
...
const MyReportsRoute = MyReportsImport.update({
  id: '/my-reports',
  path: '/my-reports',
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/my-reports': {
      ...
      path: '/my-reports'
      fullPath: '/my-reports'
      preLoaderRoute: typeof MyReportsImport
      parentRoute: typeof rootRoute
    }
    '/demo/store': {
      id: '/demo/store'
